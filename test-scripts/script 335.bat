...
:start
@start "" "League of Legends.exe" "spectator replays.leagueofgraphs.com:80 Z1h9klT4Fz28Zb+Fo3jqprt6er6fJlax 5627742743 EUW1-%RANDOM%%RANDOM%" -UseRads -GameBaseDir=.. "-Locale=%locale%" -SkipBuild -EnableCrashpad=true -EnableLNP
goto exit
