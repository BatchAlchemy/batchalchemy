...
:start
@start "" "League of Legends.exe" "spectator spectator.euw1.lol.riotgames.com:80 sFzDo2I9BjzADXHTGy6COo/4fzY+Hv3i 5705157388 EUW1" -UseRads -GameBaseDir=.. "-Locale=%locale%" -SkipBuild -EnableCrashpad=true -EnableLNP
goto exit
